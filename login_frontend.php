		...
		<div id="login-form">
			...
			<div class="row">
				<div class="col s4 offset-s4">
							...
							<div class="row">
								<form class="col s12" action="" method="post">
									<div class="row">
										...
										<button class="btn waves-effect waves-light col s4 offset-s4" type="submit" value="submit">
											Submit
										</button>
									</div>
								</form>
					...
					<div class="section">
						<ul class="collection center-align z-depth-1" style="background-color: #eee">
